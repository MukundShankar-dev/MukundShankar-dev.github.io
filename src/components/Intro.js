    ...
    return (
        <header className="intro">
            <div className="intro-copy">
                ...
                <p>I'm a master's student in Computer Science at the University of Maryland interested in building reliable AI systems and products. My work spans language-model reasoning and evaluation, multimodal learning, and production ML. Outside research, I co-founded and build <a href="https://www.fulltimebrief.com" target="_blank" rel="noopener noreferrer">Full Time Brief</a>, a live football briefing platform.</p>
                <p className="current-research">Currently, I'm researching long-form language generation, with a focus on coherence, style, and more human-like model responses.</p>
